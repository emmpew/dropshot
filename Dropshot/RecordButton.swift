...
//  Dropshot
//
//  Created by Andrew Castellanos on 3/3/17.
...
@objc open class RecordButton : UIButton {
    ...
    fileprivate func drawButton() {
        ...
        let startAngle: CGFloat = CGFloat.pi + CGFloat.pi/2
        let endAngle: CGFloat = CGFloat.pi * 3 + CGFloat.pi/2
...
//        let endAngle: CGFloat = CGFloat(M_PI) * 3 + CGFloat(M_PI_2)
    ...
    fileprivate func gradientMask() -> CAGradientLayer {
        ...
        let topColor = progressColor as UIColor
        let bottomColor = progressColor as UIColor
